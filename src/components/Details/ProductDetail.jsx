    ...
    return (
        <>
            ...
            <SmallText>
                ...
                <Typography><StyledBadge/>Buy 2 items save 5%; But 3 or more save 10% T&C</Typography>
                ...
                <TableBody>
                    ...
                    <ColumnText>
                        ...
                        <TableCell>
                            ...
                            <Typography>View more sellers statring from ₹{product.price.cost}</Typography>
                        </TableCell>
                    </ColumnText>
                    <ColumnText>
                        <TableCell colSpan={2}>
